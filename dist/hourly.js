...
function (_Component) {
  ...
  _createClass(Cron, [{
    ...
    value: function render() {
      ...
      }), React.createElement("span", null, "\xA0Cada \xA0"), React.createElement("input", {
        disabled: this.state.every ? false : true,
        type: "Number",
        onChange: this.onHourChange,
        value: this.state.value[2].split('/')[1] ? this.state.value[2].split('/')[1] : ''
      }), React.createElement("span", null, "\xA0hora(s)\xA0")), React.createElement("div", {
      ...
      }, "\xA0Hora inicio\xA0"), React.createElement("select", {
        className: "hours",
