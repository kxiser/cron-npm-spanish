...
function (_Component) {
  ...
  _createClass(Cron, [{
    ...
    value: function render() {
      ...
      }), "\xA0Día\xA0", React.createElement("input", {
        readOnly: this.state.every !== "1",
        type: "number",
        value: this.state.value[3],
        onChange: this.onDayChange
      }), "\xA0de cada mes(es)"), React.createElement("div", {
        className: "well well-small"
      }, React.createElement("input", {
        onChange: function onChange(e) {
          _this2.setState({
      ...
      }), "\xA0 Último  de cada mes \xA0"), React.createElement("div", {
        className: "well well-small"
      }, React.createElement("input", {
        onChange: function onChange(e) {
          _this2.setState({
      ...
      }), "\xA0 El último día de la semana de cada mes \xA0"), React.createElement("div", {
        className: "well well-small"
      }, React.createElement("input", {
        type: "radio",
        onChange: function onChange(e) {
      ...
      }), "\xA0día(s) antes de fin de mes"), "\xA0 Hora inicio \xA0", React.createElement("select", {
        className: "hours",
