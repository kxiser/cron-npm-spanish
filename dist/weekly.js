...
import { Checkbox, Select, Divider } from 'semantic-ui-react'
  ...
  _createClass(Cron, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        type: "checkbox",
        value: "MON",
        className: "input-check-custom-cron",
        onChange: this.onCheck,
        checked: this.state.value[5].search('MON') !== -1 ? true : false
      }), "\xA0Lunes", React.createElement("br", null), React.createElement("input", {
        type: "checkbox",
        value: "TUE",
        className: "input-check-custom-cron",
        onChange: this.onCheck,
        checked: this.state.value[5].search('TUE') !== -1 ? true : false
      }), "\xA0Martes", React.createElement("br", null), React.createElement("input", {
        type: "checkbox",
        value: "WED",
        className: "input-check-custom-cron",
        onChange: this.onCheck,
        checked: this.state.value[5].search('WED') !== -1 ? true : false
      }), "\Miercoles", React.createElement("br", null), React.createElement("input", {
        type: "checkbox",
        value: "THU",
        className: "input-check-custom-cron",
        onChange: this.onCheck,
        checked: this.state.value[5].search('THU') !== -1 ? true : false
      }), "\xA0Jueves")), React.createElement("div", {
        className: "span6 col-sm-6"
      }, React.createElement("div", {
        className: "text_align_left"
      }, React.createElement("input", {
      ...
      }), "\xA0Viernes", React.createElement("br", null), React.createElement("input", {
        type: "checkbox",
        value: "SAT",
        className: "input-check-custom-cron",
        onChange: this.onCheck,
        checked: this.state.value[5].search('SAT') !== -1 ? true : false
      }), "\xA0Sábado", React.createElement("br", null), React.createElement("input", {
        type: "checkbox",
        value: "SUN",
        className: "input-check-custom-cron",
        onChange: this.onCheck,
        checked: this.state.value[5].search('SUN') !== -1 ? true : false
      }), "\xA0Domingo"), React.createElement("br", null), React.createElement("br", null))), "\xA0 Hora inicio \xA0", React.createElement("select", {
        className: "hours",
