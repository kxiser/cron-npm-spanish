...
function (_Component) {
  ...
  _createClass(Cron, [{
    ...
    value: function render() {
      ...
      }), "\xA0 Todos los días de la semana\xA0"), "\xA0 Hora inicio\xA0", React.createElement("select", {
        id: "DailyHours",
        className: "hours",
